...
if [[ ${response:l} = y ]]; then
  # pacman_auto_install bbswitch bumblebee mesa mesa-demos nvidia nvidia-utils xf86-video-vesa xf86-video-intel nvidia-settings
  pacman_auto_install bbswitch bumblebee mesa mesa-demos nvidia nvidia-utils xf86-video-vesa nvidia-settings
